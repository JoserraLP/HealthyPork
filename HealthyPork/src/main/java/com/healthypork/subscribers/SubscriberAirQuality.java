 ...
 */
public class SubscriberAirQuality implements MqttCallback{

	private final int qos = 1;
	private String topic = "airquality";
	private MqttClient client;
	private EPRuntime runtimeEngine;

	public SubscriberAirQuality(String uri) throws MqttException, URISyntaxException {
		this(new URI(uri));

	}

	public SubscriberAirQuality(URI uri) throws MqttException {
