...
public class SubscriberHumidity implements MqttCallback {
    ...
    private String topic = "humidity";
    private MqttClient client;
    private EPRuntime runtimeEngine;

    public SubscriberHumidity(String uri) throws MqttException, URISyntaxException {
        this(new URI(uri));
        
    }

    public SubscriberHumidity(URI uri) throws MqttException {
        String host = String.format("tcp://%s:%d", uri.getHost(), uri.getPort());
        String username = "root";
        String password = "root";
        String clientId = "MQTT-HP-Humidity";
