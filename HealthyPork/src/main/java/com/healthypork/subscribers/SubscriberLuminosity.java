 ...
 */
public class SubscriberLuminosity implements MqttCallback {

    private final int qos = 1;
    private String topic = "luminosity";
    private MqttClient client;
    private EPRuntime runtimeEngine;

    public SubscriberLuminosity(String uri) throws MqttException, URISyntaxException {
        this(new URI(uri));
        
    }

    public SubscriberLuminosity(URI uri) throws MqttException {
        String host = String.format("tcp://%s:%d", uri.getHost(), uri.getPort());
        String username = "root";
        String password = "root";
        String clientId = "MQTT-HP-Luminosity";
