...
public class SubscriberNoise implements MqttCallback {
    ...
    private String topic = "noise";
    private MqttClient client;
    private EPRuntime runtimeEngine;

    public SubscriberNoise(String uri) throws MqttException, URISyntaxException {
        this(new URI(uri));
        
    }

    public SubscriberNoise(URI uri) throws MqttException {
        String host = String.format("tcp://%s:%d", uri.getHost(), uri.getPort());
        String username = "root";
        String password = "root";
        String clientId = "MQTT-HP-Noise";
