...
public class SubscriberTemperature implements MqttCallback {
    ...
    public SubscriberTemperature(String uri) throws MqttException, URISyntaxException {
        this(new URI(uri));
        
    }

    public SubscriberTemperature(URI uri) throws MqttException {
        String host = String.format("tcp://%s:%d", uri.getHost(), uri.getPort());
        String username = "root";
        String password = "root";
        String clientId = "MQTT-HP-Temperature";
