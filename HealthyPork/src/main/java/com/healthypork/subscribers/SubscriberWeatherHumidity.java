 ...
 */
public class SubscriberWeatherHumidity implements MqttCallback {

    private final int qos = 1;
    private String topic = "weather_humidity";
    private MqttClient client;
    private EPRuntime runtimeEngine;

    public SubscriberWeatherHumidity(String uri) throws MqttException, URISyntaxException {
        this(new URI(uri));
        
    }

    public SubscriberWeatherHumidity(URI uri) throws MqttException {
        String host = String.format("tcp://%s:%d", uri.getHost(), uri.getPort());
        String username = "root";
        String password = "root";
        String clientId = "MQTT-HP-WeatherHumidity";
