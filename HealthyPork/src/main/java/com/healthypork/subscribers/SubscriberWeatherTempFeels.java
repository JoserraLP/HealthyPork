 ...
 */
public class SubscriberWeatherTempFeels implements MqttCallback {

    private final int qos = 1;
    private String topic = "weather_temp_feels";
    private MqttClient client;
    private EPRuntime runtimeEngine;

    public SubscriberWeatherTempFeels(String uri) throws MqttException, URISyntaxException {
        this(new URI(uri));
        
    }

    public SubscriberWeatherTempFeels(URI uri) throws MqttException {
        String host = String.format("tcp://%s:%d", uri.getHost(), uri.getPort());
        String username = "root";
        String password = "root";
        String clientId = "MQTT-HP-WeatherTempFeels";
