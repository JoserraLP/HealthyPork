 ...
 */
public class SubscriberWeatherTempMin implements MqttCallback {

    private final int qos = 1;
    private String topic = "weather_temp_min";
    private MqttClient client;
    private EPRuntime runtimeEngine;

    public SubscriberWeatherTempMin(String uri) throws MqttException, URISyntaxException {
        this(new URI(uri));
        
    }

    public SubscriberWeatherTempMin(URI uri) throws MqttException {
